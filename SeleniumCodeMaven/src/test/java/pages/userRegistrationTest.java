...
public class userRegistrationTest {
	...
	static String user1 = "jaqinago@ema-sofia.eu";
	static String user2 = "rumehote@decabg.eu";
	public static void main(String[] args) throws InterruptedException {
		
		user1RegistrationTest();
		
		user2RegistrationTest();
	}
	
	public static void user1RegistrationTest() throws InterruptedException {
